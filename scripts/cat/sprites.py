...
for x in [
    ...
    'plant2_accessories', 'flower_accessories', 'snake_accessories', 'smallAnimal_accessories', 'aliveInsect_accessories',
    'deadInsect_accessories', 'fruit_accessories', 'crafted_accessories', 'tail2_accessories'
...
# SKINS
for a, i in enumerate(['BLACK', 'PINK', 'DARKBROWN', 'BROWN', 'LIGHTBROWN']):
